...
// import { getAtores } from "./cmsatores.js"
...
async function adicionarTodosOsFilmes(){
        const filmes=await getFilmes()
preencherContainer(filmes)
}

async function preencherContainer(filmesarray){
